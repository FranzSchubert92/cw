/*
Challenge: use regular expressions (RegEx) to remove instances of words that 
are repeated more than once, but retain the first occurrence of any case-
insensitive repeated word. For example, the words "love" and "to" are repeated 
in the sentence 

    I love Love to To tO code
   
Write a program to transform a sentence like the abnove into 
